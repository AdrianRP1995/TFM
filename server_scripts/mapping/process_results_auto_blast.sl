...
cut -f 1,2 ~/TFM/mapping/results/auto_blast_2/sorted_auto_blast_2.blast | sed 's/REF://g'| sort -u | sort -k 2 > ~/TFM/mapping/results/auto_blast_2/auto_blast_results.tsv
...
sed -i '1i \sub_seq_id\tobj_seq_id' ~/TFM/mapping/results/auto_blast_2/auto_blast_results.tsv
#We add a header to the results file, to convert it into a dataframe in the future


cut -f 2 ~/TFM/mapping/results/auto_blast_2/auto_blast_results.tsv > ~/TFM/mapping/results/auto_blast_2/auto_blast_hits_list.txt
#We extract a list of the object sequences


python ~/TFM/mapping/scripts/virus_genomes_obtain_hits_metadata.py ~/TFM/mapping/results/auto_blast_2/auto_blast_hits_list.txt ~/TFM/mapping/metadata/autoblast_hits_metadata.tsv
#This script makes a tsv file which contains the metadata informarion for each hit in blast


paste ~/TFM/mapping/results/auto_blast_2/auto_blast_results.tsv ~/TFM/mapping/metadata/autoblast_hits_metadata.tsv | cut -f 1,2,4,5,6 > ~/TFM/mapping/tables/autoblast_results_table.tsv
