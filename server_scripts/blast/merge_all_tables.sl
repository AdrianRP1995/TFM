...
paste ~/TFM/crispr/tables/clustering_definitive_results.tsv ~/TFM/blast/tables/blast_definitive_results.tsv | cut -f 1,2,3,4,5,7,8,9,10 > ~/TFM/metadata/results/array_filtering_results.tsv
